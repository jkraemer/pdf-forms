...
First get pdftk from http://www.accesspdf.com/pdftk/ and install it.
  ...
  # take form.pdf, set the 'foo' field to 'bar' and save the document as a pdf form to myform.pdf
  pdftk.fill_form '/path/to/form.pdf', 'myform.pdf', :foo => 'bar'

  # take form.pdf, set the 'foo' field to 'bar' and save the document as a flattened pdf to myform.pdf
  pdftk.fill_flattened_form '/path/to/form.pdf', 'myform.pdf', :foo => 'bar'
